...
function statusPage(env: RuntimeEnv): Response {
  ...
  const version = escapeHtml(env.CREIXEMENT_RUNTIME_VERSION ?? "0.9.0");
...
<body><main><div class="hero"><div><div class="eyebrow">Creixement Control Plane · Runtime</div><h1>Kairon</h1><p>This endpoint is the Cloudflare execution engine. The operator cockpit lives on the dedicated Lovable/GitHub UI branch. Configuration is not execution; deployment is not a verified external outcome.</p></div><div class="live"><span class="dot"></span>Worker deployed</div></div>
